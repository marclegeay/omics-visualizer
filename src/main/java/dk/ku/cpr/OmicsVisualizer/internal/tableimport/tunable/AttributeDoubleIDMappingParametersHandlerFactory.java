...
public class AttributeDoubleIDMappingParametersHandlerFactory implements GUITunableHandlerFactory {
	...
	public AttributeDoubleIDMappingParametersHandlerFactory(final ImportType dialogType,
	...
	public GUITunableHandler createTunableHandler(Field field, Object instance, Tunable t) {
		...
		return new AttributeDoubleIDMappingParametersHandler(field, instance, t, dialogType, serviceRegistrar);
	}
	...
	public GUITunableHandler createTunableHandler(Method getter, Method setter, Object instance, Tunable tunable) {
		...
		return new AttributeDoubleIDMappingParametersHandler(getter, setter, instance, tunable, dialogType, serviceRegistrar);
	}
}
