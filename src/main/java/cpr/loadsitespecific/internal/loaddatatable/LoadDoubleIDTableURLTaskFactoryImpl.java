...
public class LoadDoubleIDTableURLTaskFactoryImpl extends AbstractTaskFactory implements LoadTableURLTaskFactory {

	private final CyServiceRegistrar serviceRegistrar;

	public LoadDoubleIDTableURLTaskFactoryImpl(final CyServiceRegistrar serviceRegistrar) {
		this.serviceRegistrar = serviceRegistrar;
	}

	@Override
	public TaskIterator createTaskIterator() {
		return new TaskIterator(2, new LoadDoubleIDTableURLTask(serviceRegistrar));
	}
